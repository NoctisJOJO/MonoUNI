...
def do_repo3d_eval(
    logger, label_dir, det_dir, calib_dir, de_norm_dir, eval_cls, ap_mode=40
):
    ...
    #eval_from_scrach(logger, label_dir, det_dir, eval_cls, ap_mode=40)
